        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("a1000002-0000-0000-0000-000000000000"), "BE", new DateOnly(2026, 4, 5), "Easter Monday", 0 },
                    { new Guid("a1000003-0000-0000-0000-000000000000"), "BE", new DateOnly(2026, 5, 1), "Labour Day", 0 },
                    { new Guid("a1000004-0000-0000-0000-000000000000"), "BE", new DateOnly(2026, 5, 13), "Ascension Day", 0 },
                    { new Guid("a1000005-0000-0000-0000-000000000000"), "BE", new DateOnly(2026, 5, 24), "Whit Monday", 0 },
                    ...
                    { new Guid("a2000002-0000-0000-0000-000000000000"), "BE", new DateOnly(2027, 3, 28), "Easter Monday", 0 },
                    { new Guid("a2000003-0000-0000-0000-000000000000"), "BE", new DateOnly(2027, 5, 1), "Labour Day", 0 },
                    { new Guid("a2000004-0000-0000-0000-000000000000"), "BE", new DateOnly(2027, 5, 5), "Ascension Day", 0 },
                    { new Guid("a2000005-0000-0000-0000-000000000000"), "BE", new DateOnly(2027, 5, 16), "Whit Monday", 0 },
                    ...
                    { new Guid("a3000002-0000-0000-0000-000000000000"), "BE", new DateOnly(2028, 4, 16), "Easter Monday", 0 },
                    { new Guid("a3000003-0000-0000-0000-000000000000"), "BE", new DateOnly(2028, 5, 1), "Labour Day", 0 },
                    { new Guid("a3000004-0000-0000-0000-000000000000"), "BE", new DateOnly(2028, 5, 24), "Ascension Day", 0 },
                    { new Guid("a3000005-0000-0000-0000-000000000000"), "BE", new DateOnly(2028, 6, 4), "Whit Monday", 0 },
