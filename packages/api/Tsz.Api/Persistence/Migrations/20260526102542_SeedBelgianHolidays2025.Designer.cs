...
namespace Tsz.Api.Persistence.Migrations
{
    ...
    [Migration("20260526102542_SeedBelgianHolidays2025")]
    partial class SeedBelgianHolidays2025
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tsz.Modules.Timesheets.Domain.Timesheets.TimesheetWeek", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("UserId", "IsoYear", "IsoWeek")
                        .IsUnique();

                    b.ToTable("TimesheetWeeks", (string)null);
                });
            ...
            modelBuilder.Entity("Tsz.Modules.Timesheets.Domain.Timesheets.TimesheetWeek", b =>
                {
                    b.OwnsMany("Tsz.Modules.Timesheets.Domain.Timesheets.LeaveBooking", "LeaveBookings", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT");
                            ...
                            b1.Property<decimal>("DurationHours")
                                .HasColumnType("decimal(3,2)");

                            b1.Property<Guid>("LeaveTypeId")
                                .HasColumnType("TEXT");

                            b1.Property<Guid>("TimesheetWeekId")
                                .HasColumnType("TEXT");

                            b1.HasKey("Id");

                            b1.HasIndex("TimesheetWeekId");
                    ...
                    b.OwnsMany("Tsz.Modules.Timesheets.Domain.Timesheets.TimeEntry", "TimeEntries", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT");

                            b1.Property<Guid>("ContractTaskId")
                                .HasColumnType("TEXT");
